export const Constants = {
  ...
  RULES: {
    en: ['Several players (up to 4) take part in the game. Everyone has their own personal account. At the start of the game, each player has 0.',
    ...
    ru: ['В игре принимают участие несколько игроков(до 4). У каждого имеется свой персональный счёт. В начале игры у каждого игрока 0.',
