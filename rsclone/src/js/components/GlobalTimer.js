...
export class GlobalTimer {
  ...
  renderTimer() {
    ...
    this.header = Extra.createMultipleLanguageElement('div',
      ['global-timer__header'],
      'Total playing time', 'Общее время игры');
  ...
  setTimer() {
    ...
    this.initialTimer = setInterval(() => {
      ...
      document.querySelector('.time')
        .replaceWith(this.renderTime(time.hour, time.min, time.sec));
    }, 1000);
  }
